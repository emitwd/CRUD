...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\emirm\Desktop\Proyectos de Python\CRUD\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\emirm\Desktop\Proyectos de Python\CRUD\env\Scripts\deactivate.nu'
